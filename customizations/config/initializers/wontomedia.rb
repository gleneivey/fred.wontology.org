...
WontoMedia = OpenStruct.new({
  :site_title => "WontoMedia Staging",
  :site_tagline => "WontoMedia Staging",
  :site_logo_title => "<div style='margin-bottom: 0.5em; margin-top: 0.25em; text-align: center;'><span style='color: black; font-family: Monotype Corsiva, Apple Chancery, URW Chancery L, chancery, script, cursive; font-style: italic; font-size: 130%;'>WontoMedia Staging Server</span></div>",
